...
body, html {
        margin: 0;
        padding: 0;
        background-image: url('https://cdn.thecoolist.com/wp-content/uploads/2021/12/Best-Places-to-Visit-in-Alaska.jpg');
...
form {
    ...
    box-shadow: 0 0 10px rgba(255, 102, 0, 0.5); /* Halloween orange shadow */
    color: white;
}
...
<body>
    ...
    <div class="main">
        ...
        <p style="background-image: url('https://cdn.thecoolist.com/wp-content/uploads/2021/12/Best-Places-to-Visit-in-Alaska.jpg');"></p>
      
        <div class="content">
            
          
            <form action="" onsubmit="return validateForm()">
                <form id="signUpForm" onclick="validateSignUp()">
                    <h2>Sign up</h2>
    ...
    <script>
        ...
        var namePattern = /^[A-Z][a-zA-Z]{0,9}$/;
